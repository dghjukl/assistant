...
- `Setup-Full.ps1` — downloads the full recommended model/binary set
- `Setup-Lite.ps1` — downloads supporting assets but expects you to provide large models yourself
...
| Vision | Run `start-vision-gpu.bat` alongside your normal backend bundle |
