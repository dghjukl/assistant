...
- `start-main-cpu.bat` / `start-main-gpu.bat`
- `start-tools-cpu.bat` / `start-tools-gpu.bat`
- `start-thinking-cpu.bat` / `start-thinking-gpu.bat`
- `start-creativity-cpu.bat` / `start-creativity-gpu.bat`
...
- `start-minimal.bat` → main + tools
- `start-standard.bat` → main + tools + thinking
- `start-full.bat` → main + tools + thinking + creativity
